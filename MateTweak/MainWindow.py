...
class MateTweak:
    ...
    def disable_autostart(self, filename):
    ...
    def replace_windowmanager(self, new_wm):
        ...
        if new_wm == 'marco-no-composite' or new_wm == 'compiz':
            self.remove_autostart('picom.desktop') # Remove autostart picom
    ...
    def disable_applets(self):
        ...
        self.disable_autostart('mate-volume-control-status-icon.desktop')
    ...
    def make_list_of_window_managers(self):
        ...
        if self.marco_capable:
            ...
            try:
                ...
                pass
            wms.append([_("Marco (built-in: "+compositor+") - The MATE Factory default"), 'marco'])
