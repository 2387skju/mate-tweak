...
- [x] [minimal changes: deprecated part ; missing check at layout opensuse ; keep history-last-run ; active compiz was not detected ](https://github.com/ubuntu-mate/mate-tweak/pull/112)
